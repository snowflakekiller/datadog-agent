...
func NewSerializer(forwarder forwarder.Forwarder) *Serializer {
	return &Serializer{
		Forwarder:            forwarder,
		enableEvent:          config.Datadog.GetBool("serializer_enable_event"),
		enableSeries:         config.Datadog.GetBool("serializer_enable_series"),
		enableServiceCheck:   config.Datadog.GetBool("serializer_enable_service_check"),
		enableSketches:       config.Datadog.GetBool("serializer_enable_sketches"),
		enableMetadata:       config.Datadog.GetBool("serializer_enable_metadata"),
		enableJSONToV1Intake: config.Datadog.GetBool("serializer_enable_json_to_v1_intake"),
	}
}
